                  ...
                  <div key={key} id={`field-${key}`} style={{ gridColumn: full ? "1 / -1" : undefined, display: "flex", flexDirection: "column", gap: 6 }}>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        background: errors[key] ? "rgba(239,68,68,0.03)" : undefined,
          ...
          >
              ...
              <>
                {cartItems.map((item) => (
                  <div key={item.cartId} style={{ display: "flex", gap: 14, alignItems: "center", padding: "14px 0", borderBottom: "1px solid var(--border)" }}>
                    <div style={{ width: 64, height: 76, borderRadius: 12, background: item.bgColor, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, flexShrink: 0 }}>
                      {item.emoji}
                    </div>
                    <div style={{ flex: 1 }}>
                ...
                {[["Subtotal", `₹${cartTotal.toLocaleString()}`], ["Shipping", shipping === 0 ? "FREE" : `₹${shipping}`]].map(([label, val]) => (
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: 16, borderTop: "2px solid var(--dark)" }}>
                  ...
                  <span style={{ fontFamily: "var(--serif)", fontSize: 28, fontWeight: 700 }}>₹{grandTotal.toLocaleString()}</span>
                </div>
              </>
            )}
            ...
            <motion.button
              ...
              style={{
                ...
                border: "none",
                cursor: loading ? "wait" : cartItems.length === 0 ? "not-allowed" : "pointer",
                marginTop: 24,
